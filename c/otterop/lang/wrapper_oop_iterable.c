...
otterop_lang_WrapperOOPIterable_new_array(void **array, int32_t array_cnt, void *(*wrap)(void *)) {
...
otterop_lang_WrapperOOPIterable_new(void *it_self, unsigned char (*it)(void *self, void **next), void *(*wrap)(void *)) {
